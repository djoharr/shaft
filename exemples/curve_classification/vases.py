...
def main():
    vases = np.load(join(dirname(__file__), "../../data/curves/vases/curves.npy"))
    vases_info = pd.read_csv(join(dirname(__file__), "../../data/curves/vases/info.csv"))

    print('....................... COMPUTING CFTs ....................... ')
    k_range = 20
    all_coefs = np.zeros((len(vases), k_range**2, 2))
    for i in tqdm(range(len(vases))):
        curve = vases[i] / 1.5
