...
def main():
    leaves = np.load(join(dirname(__file__), "../../data/curves/leaves/curves.npy"))
    leaves_info = pd.read_csv(join(dirname(__file__), "../../data/curves/leaves/info.csv"))

    print('....................... COMPUTING CFTs ....................... ')
    k_range = 20
    all_coefs = np.zeros((len(leaves), k_range**2, 2))
